...
Hive Mind is a consumer-facing trust layer for Web3, powered by [Intuition](https://intuition.systems). See community trust signals before you sign transactions, create trust attestations, and help others avoid scams.

<img alt="Hive Mind Snap Screenshot" src="https://github.com/user-attachments/assets/6f599b3b-7198-48d9-ac40-ba33db0d0470" />

## What is Hive Mind?

Hive Mind brings Intuition's decentralized knowledge graph directly into your wallet. When you're about to send a transaction, Hive Mind shows you what the community thinks about the destination address—before you click "Confirm."
...
Hive Mind displays real-time trust signals from Intuition's knowledge graph:
...
**Link:** [hivemindhq.io](https://hivemindhq.io)
...
└─────────────────────────────────────────────────────────────┘
                              ...
                              ▼
┌─────────────────────────────────────────────────────────────┐
│              MetaMask + Hive Mind Snap                          │
│                                                              │
│   "Insights from Hive Mind"                                     │
│   ┌─────────────────────────────────────────────────────┐   │
...
Hive Mind queries Intuition for trust triples in the format:
...
2. Install the Hive Mind Snap:
   - From MetaMask Snaps Directory (coming soon)
   - Or directly: `npm:@hivemindhq/snap`
3. Use MetaMask normally—Hive Mind insights appear automatically

### Create Trust Signals

1. Visit [Hive Mind Explorer](https://hivemindhq.io)
...
The Hive Mind Snap requests these permissions:
...
**Security Note:** Hive Mind does NOT request key management permissions. It cannot access your private keys or sign transactions on your behalf.

---

## Roadmap

- [x] Hive Mind Snap v1.0.0
- [x] npm package published
- [ ] MetaMask Snaps Directory listing
- [ ] Hive Mind Explorer v1.0
...
Hive Mind is built on [Intuition](https://intuition.systems), a decentralized knowledge graph protocol. Intuition allows anyone to create attestations about any subject and stake economic value behind their claims.
