...
### Changed
- **Documentation**: Added atom IDs (term_ids) to README for reference
...
[1.3.0]: https://github.com/hivemindhq-io/snap/releases/tag/v1.3.0
[1.3.1]: https://github.com/hivemindhq-io/snap/releases/tag/v1.3.1
